...
const languageContent = {
  vi: {
    ...
    filterNoTasksInCategory: (category) => `Chưa có công việc nào trong danh mục "${languageContent.vi.taskCategories[category]}".`, // Access via languageContent.vi
  ...
  ja: {
    ...
    filterNoTasksInCategory: (category) => `"${languageContent.ja.taskCategories[category]}"カテゴリにはタスクがありません。`, // Access via languageContent.ja
